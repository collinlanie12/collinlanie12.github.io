...
const artifacts: Project[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "This enhancement met the course outcome that was planned, which is: ",
    ],
    outcomes: [
